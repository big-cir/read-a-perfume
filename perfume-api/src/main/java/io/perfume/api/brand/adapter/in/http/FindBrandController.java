...
public class FindBrandController {
  ...
  @GetMapping
  public ResponseEntity<CustomPage<GetBrandPageResult>> getPageBrands(
      final GetBrandsRequestDto dto) {
    CustomPage<GetBrandPageResult> response =
        findBrandUseCase.getPaginatedPageBrands(
